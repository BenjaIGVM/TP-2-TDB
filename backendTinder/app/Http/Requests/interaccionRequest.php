...
class interaccionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'perro_candidato_id' => [
                'required',
                'integer',
                Rule::unique('interacciones')->where(function ($query) {
                    return $query->where('perro_interesado_id', $this->input('perro_interesado_id'));
                }),
            ],
    ...
    public function messages()
    {
        return [
            ...
            'perro_candidato_id.unique' => 'La combinación de estos perros ya existe',
