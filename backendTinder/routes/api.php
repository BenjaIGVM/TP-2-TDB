...
Route::prefix("interaccion")->group(function () {
    ...
    Route::get("getByPerro", "App\Http\Controllers\InteraccionController@getInteraccionesByPerro");
    ...
    Route::delete("deleteAll", "App\Http\Controllers\InteraccionController@deleteAllInteracciones");
});
